...
*/
'use strict';
const qMockUtil = require('./util.js');

;(function(){
	var jQuery = {
		isArray: qMockUtil.isArray
	};

	// Begin https://github.com/mennovanslooten/mockJSON
	(function($) {
	...
	// End https://github.com/mennovanslooten/mockJSON

	module.exports = jQuery.mockJSON;
})();